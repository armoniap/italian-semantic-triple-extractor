  ...
  const features = [
    {
      ...
      description:
        'Specializzato nel riconoscimento di entità italiane: luoghi, persone, istituzioni e cultura.',
    },
    {
      icon: Zap,
      title: 'AI Avanzata',
      description:
        'Utilizza Google Gemini per analisi semantiche profonde e estrazione di triple RDF.',
    },
    {
      icon: Shield,
      title: 'Privacy e Sicurezza',
      description:
        'Elaborazione client-side, API key criptate, nessun invio di dati a server esterni.',
    },
    {
      icon: Download,
      title: 'Export Multipli',
      description:
        'Esporta risultati in JSON, CSV, RDF/Turtle per integrazione con altri sistemi.',
    },
    {
      icon: BarChart3,
      title: 'Analisi Avanzate',
      description:
        'Statistiche dettagliate, grafi di relazioni e insights automatici sui dati estratti.',
    },
  ];
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="text-center py-12">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
          Strumento avanzato per l'estrazione automatica di entità e relazioni
          semantiche da testo italiano utilizzando l'intelligenza artificiale di
          Google Gemini.
        </p>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-1 text-sm text-yellow-700">
                Per utilizzare il tool è necessario configurare una API key di
                Google Gemini.{' '}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="text-center p-6 bg-white rounded-lg border hover:shadow-lg transition-shadow"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {examples.map((example, index) => (
            <div key={index} className="bg-white p-6 rounded-lg border">
              ...
              <div className="text-gray-600 italic mb-4">"{example.text}"</div>
      ...
      <div className="text-center py-12">
        <div className="bg-gradient-to-r from-italian-green to-green-600 rounded-2xl p-8 text-white">
          ...
          <p className="text-xl mb-6 opacity-90">
            Inizia subito ad estrarre entità e relazioni semantiche dai tuoi
            testi italiani
          </p>
          <Link
